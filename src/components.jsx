...
export function Home(){
  ...
  <section className="mojoSection" style={{backgroundColor: 'var(--bg)'}}><div className="container mojoLayout"><div className="mojoVisual"><img src="/images/mascot-image.png" alt="Mojo Mix mascot" className="mojoMascot" /></div><div className="mojoCopy"><span className="mojoBadge">NEW TECHNOLOGY</span><img className="mojoLogo" src="/images/The Neon Stack Logo without icon.svg" alt="The Neon Stack"/><h2><span className="mojoMeet">Meet</span><span className="mojoMix">Mojo Mix</span></h2><p>Unlimited color changing options, 200+ flow modes, music sync, and app control. It's not just a sign, it's an experience.</p><Link className="btn primary" href="/mojo-mix">Explore Mojo Mix Collection <ArrowRight/></Link></div></div></section>
